<template>
  <section class="products q-pt-xl container">
    <div class="category_wrapper">
      ...
      <div class="righ">
        <div class="search_text_wrap q-pb-lg row justify-between items-start">
          <div class="search_left">
            <div v-if="products.length" class="search_small">
              {{ products.length }} results for
            </div>
            <div v-else class="search_small">0 results for</div>
            <div class="main_result_text">
              {{ this.$router.currentRoute.value.params.slug }}
...
export default defineComponent({
  ...
  methods: {
    ...
    getSearched() {
      let search = this.$router.currentRoute.value.params.slug;
